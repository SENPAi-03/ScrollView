...
import font.viewer.widget.ScrollView;
...
public class SpreadsheetActivity extends AppCompatActivity {
    ...
    /**
     * Sets {@link ScrollView} to adjust headers on scroll
     */
    ...
    private void setupScrollers() {
        ...
        final ScrollView Scroller = findViewById(R.id._scroller);
        Scroller.addOnScrollListener((left, top, oldLeft, oldTop) -> {
